...
project = "reaction-network-graph"
copyright = "2026 Andreas V. Copan"
author = "Andreas V. Copan"
release = metadata.version("reaction_network_graph")
...
html_static_path = []
html_theme_options = {
    "github_url": "https://github.com/avcopan/reaction-network-graph",
}
